...
pub struct MapAddEntryListenerToKeyWithPredicateCodec;

impl MapAddEntryListenerToKeyWithPredicateCodec {

    // hex: 0x011600
    const REQUEST_MESSAGE_TYPE: i32 = 71168;
    // hex: 0x011601
    // RESPONSE_MESSAGE_TYPE = 71169
    // hex: 0x011602
    const EVENT_ENTRY_MESSAGE_TYPE: i32 = 71170;
    ...
    pub fn encode_request<'a>(name: &'a String, key: &'a HeapData, predicate: &'a HeapData, include_value: &'a bool, listener_flags: &'a i32, local_only: &'a bool) -> Pin<Box<dyn Future<Output=ClientMessage> + Send + Sync + 'a>> {
        Box::pin(async move {
