...
pub struct MultiMapAddEntryListenerCodec;

impl MultiMapAddEntryListenerCodec {

    // hex: 0x020E00
    const REQUEST_MESSAGE_TYPE: i32 = 134656;
    // hex: 0x020E01
    // RESPONSE_MESSAGE_TYPE = 134657
    // hex: 0x020E02
    const EVENT_ENTRY_MESSAGE_TYPE: i32 = 134658;
    ...
    pub fn encode_request<'a>(name: &'a String, include_value: &'a bool, local_only: &'a bool) -> Pin<Box<dyn Future<Output=ClientMessage> + Send + Sync + 'a>> {
        Box::pin(async move {
