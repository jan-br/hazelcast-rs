...
pub struct MultiMapContainsEntryCodec;

impl MultiMapContainsEntryCodec {

    // hex: 0x020900
    const REQUEST_MESSAGE_TYPE: i32 = 133376;
    // hex: 0x020901
    ...
    pub fn encode_request<'a>(name: &'a String, key: &'a HeapData, value: &'a HeapData, thread_id: &'a i64) -> Pin<Box<dyn Future<Output=ClientMessage> + Send + Sync + 'a>> {
        Box::pin(async move {
