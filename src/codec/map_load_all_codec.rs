...
pub struct MapLoadAllCodec;

impl MapLoadAllCodec {

    // hex: 0x012000
    const REQUEST_MESSAGE_TYPE: i32 = 73728;
    // hex: 0x012001
    ...
    pub fn encode_request<'a>(name: &'a String, replace_existing_values: &'a bool) -> Pin<Box<dyn Future<Output=ClientMessage> + Send + Sync + 'a>> {
        Box::pin(async move {
