...
struct WeakMapProxyInner<
    K: Serializable + Clone + Send + Sync + Eq + PartialEq + Hash + 'static,
    V: Serializable + Clone + Send + Sync + 'static,
> {
    inner: MapProxy<K, V>,
...
impl<
        K: Serializable + Clone + Send + Sync + Eq + PartialEq + Hash + 'static,
        V: Serializable + Clone + Send + Sync + 'static,
    > From<MapProxy<K, V>> for WeakMapProxy<K, V>
{
...
impl<
        K: Serializable + Send + Sync + Clone + Eq + PartialEq + Hash + 'static,
        V: Serializable + 'static + Clone + Send + Sync,
    > WeakMapProxy<K, V>
{
